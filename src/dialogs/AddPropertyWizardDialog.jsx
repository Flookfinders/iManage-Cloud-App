    ...
    const createBlankData = () => {
      if (isRange.current) {
        engData = {
          ...
          rangeType: null,
          rangeText: null,
          rangeStartPrefix: null,
          rangeStartNumber: null,
          rangeStartSuffix: null,
          rangeEndPrefix: null,
          rangeEndNumber: null,
          rangeEndSuffix: null,
          numbering: 1,
        ...
        if (returnValue) {
          ...
          if (isRange.current) {
            engData = {
              ...
              rangeEndSuffix: null,
              numbering: 1,
              paoStartNumber: engParentLpi && engParentLpi.length > 0 ? engParentLpi[0].paoStartNumber : null,
              paoStartSuffix: engParentLpi && engParentLpi.length > 0 ? engParentLpi[0].paoStartSuffix : null,
              paoEndNumber: engParentLpi && engParentLpi.length > 0 ? engParentLpi[0].paoEndNumber : null,
              paoEndSuffix: engParentLpi && engParentLpi.length > 0 ? engParentLpi[0].paoEndSuffix : null,
              paoText: engParentLpi && engParentLpi.length > 0 ? engParentLpi[0].paoText : null,
              paoDetails: engParentLpi && engParentLpi.length > 0 ? getPaoDetails(engParentLpi[0]) : null,
              usrn: parent.usrn,
              postcodeRef: null,
              postTownRef: selectedTemplate.current.postTownRef,
          ...
          if (settingsContext.isScottish) {
            ...
            if (isRange.current) {
              altLangData = {
                ...
                rangeEndSuffix: null,
                numbering: 1,
                paoStartNumber: gaeParentLpi && gaeParentLpi.length > 0 ? gaeParentLpi[0].paoStartNumber : null,
                paoStartSuffix: gaeParentLpi && gaeParentLpi.length > 0 ? gaeParentLpi[0].paoStartSuffix : null,
                paoEndNumber: gaeParentLpi && gaeParentLpi.length > 0 ? gaeParentLpi[0].paoEndNumber : null,
                paoEndSuffix: gaeParentLpi && gaeParentLpi.length > 0 ? gaeParentLpi[0].paoEndSuffix : null,
                paoText: gaeParentLpi && gaeParentLpi.length > 0 ? gaeParentLpi[0].paoText : null,
                paoDetails: gaeParentLpi && gaeParentLpi.length > 0 ? getPaoDetails(gaeParentLpi[0]) : null,
                usrn: parent.usrn,
                postcodeRef: null,
                postTownRef: altLangPostTownRecord ? altLangPostTownRecord.postTownRef : null,
                subLocalityRef: altLangSubLocalityRecord ? altLangSubLocalityRecord.subLocalityRef : null,
            ...
            if (isRange.current) {
              altLangData = {
                ...
                rangeEndSuffix: null,
                numbering: 1,
                paoStartNumber: cymParentLpi && cymParentLpi.length > 0 ? cymParentLpi[0].paoStartNumber : null,
                paoStartSuffix: cymParentLpi && cymParentLpi.length > 0 ? cymParentLpi[0].paoStartSuffix : null,
                paoEndNumber: cymParentLpi && cymParentLpi.length > 0 ? cymParentLpi[0].paoEndNumber : null,
                paoEndSuffix: cymParentLpi && cymParentLpi.length > 0 ? cymParentLpi[0].paoEndSuffix : null,
                paoText: cymParentLpi && cymParentLpi.length > 0 ? cymParentLpi[0].paoText : null,
                paoDetails: cymParentLpi && cymParentLpi.length > 0 ? getPaoDetails(cymParentLpi[0]) : null,
                usrn: parent.usrn,
                postcodeRef: null,
                postTownRef: altLangPostTownRecord ? altLangPostTownRecord.postTownRef : null,
                subLocalityRef: null,
